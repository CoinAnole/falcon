...
const SETTINGS: SettingItem[] = [
  { key: "defaultModel", label: "Default Model", type: "select", options: GENERATION_MODELS },
  { key: "defaultAspect", label: "Default Aspect", type: "select", options: ASPECT_RATIOS },
  { key: "defaultResolution", label: "Default Resolution", type: "select", options: RESOLUTIONS },
  { key: "upscaler", label: "Upscaler", type: "select", options: ["clarity", "crystal"] },
  { key: "backgroundRemover", label: "BG Remover", type: "select", options: ["rmbg", "bria"] },
